(function () {
  ...
  function renderProduct(p) {
    ...
    var pills = (profile.pills || ["💵 الدفع عند الاستلام", "🚚 توصيل لجميع الولايات"]).map(function (pill) {
            ...
            '<div class="pd-order-box" id="pdOrder">' +
              ...
              '<form id="pdOrderForm" class="pd-order-form">' +
                ...
                '<div class="pd-order-summary">' +
                  ...
                  '<div class="summary-row summary-ship"><span>التوصيل</span><span id="pdSummaryShipping">حسب الولاية</span></div>' +
